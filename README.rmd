---
title: "foofactors R package (Homework 09)"
...
The `sample_random_table()` function returns a random set of rows from a specified data.frame:

```
sample_random_table(iris, 15)
```